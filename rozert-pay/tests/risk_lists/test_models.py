...
class TestRiskListEntryModel:
    ...
    @pytest.mark.parametrize(
        "scope, factory_kwargs, expected_error_match",
        [
            pytest.param(
                Scope.GLOBAL,
                {
                ...
                "For GLOBAL scope, 'merchant' must be empty",
            ...
            pytest.param(
                ...
                "For GLOBAL scope, 'wallet' must be empty",
            ...
            pytest.param(
                ...
                "Customer is required for Merchant scope",
            ...
            pytest.param(
                ...
                "Customer is required for Wallet scope",
                id="wallet_without_customer_fails",
            ),
        ],
    )
    def test_scope_constraints(
        self,
        scope: Scope,
        ...
        """
        Verifies validation constraints for different scopes.
        """
        with pytest.raises(ValidationError, match=expected_error_match):
            GrayListEntryFactory.build(scope=scope, **factory_kwargs).clean()
