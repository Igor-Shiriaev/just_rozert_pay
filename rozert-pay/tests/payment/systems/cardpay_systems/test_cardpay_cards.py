...
class TestCardpayBankcardFlow:
    ...
    def test_withdraw_flow_no_user_data(
        ...
        trx.customer.email_encrypted = None
        trx.customer.save()
    ...
    def test_client_refund_callback(
        ...
        oc = OutcomingCallback.objects.get()
        assert oc.body["status"] == "refunded"
    ...
    def test_withdraw_flow_success_with_negative_balance(
        ...
        assert card_trx.wallet.operational_balance == Decimal("-90.00")
