...
class WorldpayDepositSerializer(  # type: ignore[misc]
    ...
    request_3ds_challenge = rest_serializers.BooleanField(required=True)
    ...
    def _get_extra(self) -> dict[str, Any]:
        return {
            ...
            WorldpayTransactionExtraFields.REQUEST_3DS_CHALLENGE: self.validated_data[
                "request_3ds_challenge"
            ],
        }
