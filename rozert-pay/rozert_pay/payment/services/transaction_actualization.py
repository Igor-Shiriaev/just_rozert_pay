...
from rozert_pay.payment.services import event_logs, transaction_status_validation
...
class BaseTransactionActualizer(ty.Generic[TForm]):
    ...
    @track_duration("BaseTransactionActualizer.get_remote_status")
    ...
    @wrap_errors
    @track_duration("BaseTransactionActualizer.get_form")
    ...
    @wrap_errors
    @track_duration("BaseTransactionActualizer.save_form")
