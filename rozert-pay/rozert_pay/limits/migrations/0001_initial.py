# Generated by Django 5.1.3 on 2025-06-27 09:27
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Максимальный процент всех деклайнов",
                        max_digits=5,
                        null=True,
                        validators=[
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Максимальный процент отклонённых выплат",
                        max_digits=5,
                        null=True,
                        validators=[
                            django.core.validators.MinValueValidator(0),
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Максимальный процент отклонённых депозитов",
                        max_digits=5,
                        null=True,
                        validators=[
                            django.core.validators.MinValueValidator(0),
