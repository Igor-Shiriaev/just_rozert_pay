...
class CustomerLimit(BaseDjangoModel):
    ...
    min_operation_amount = fields.MoneyField(  # type: ignore[misc]
    ...
    max_operation_amount = fields.MoneyField(  # type: ignore[misc]
    ...
    total_successful_amount = fields.MoneyField(  # type: ignore[misc]
...
class RiskCustomerLimitManager(models.Manager["CustomerLimit"]):
    def get_queryset(self) -> models.QuerySet["CustomerLimit"]:
        return super().get_queryset().filter(category=LimitCategory.RISK)


class BusinessCustomerLimitManager(models.Manager["CustomerLimit"]):
    def get_queryset(self) -> models.QuerySet["CustomerLimit"]:
        return super().get_queryset().filter(category=LimitCategory.BUSINESS)


class RiskCustomerLimit(CustomerLimit):
    objects: models.Manager["RiskCustomerLimit"] = RiskCustomerLimitManager()  # type: ignore[misc, assignment]
...
class BusinessCustomerLimit(CustomerLimit):
    objects: models.Manager["BusinessCustomerLimit"] = BusinessCustomerLimitManager()  # type: ignore[misc, assignment]
