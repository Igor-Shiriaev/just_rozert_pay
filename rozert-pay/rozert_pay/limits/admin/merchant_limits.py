...
class GlobalRiskMerchantLimitAdmin(CategoryLimitAdminBase, MerchantLimitAdmin):
    ...
    def get_form(
        ...
        **kwargs: Any,
        ...
        if "scope" in form.base_fields:
            form.base_fields["scope"].choices = [  # type: ignore[attr-defined]
                (MerchantLimitScope.WALLET.value, MerchantLimitScope.WALLET.label),
            ]
        return form
