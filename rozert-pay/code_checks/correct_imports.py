...
class RestrictImportChecker(BaseChecker):
    ...
    # This pattern matches imports from submodules of models (e.g., "rozert_pay.payment.models.something")
    # but allows imports from models package itself (e.g., "rozert_pay.payment.models")
    # Pattern requires at least one character after "models." to match submodules only
