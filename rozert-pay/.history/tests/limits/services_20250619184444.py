...
from rozert_pay.limits.models.common import LimitPeriod
...
from tests.factories import CustomerLimitFactory, PaymentSystemFactory
...
from tests.payment.systems.test_spei_stp import MockBehaviourContainer, mock_requests
...
class TestCustomerLimits:
    ...
    def c(
        ...
        self.mock_behavior = MockBehaviourContainer()
        with (mock_requests(self.mock_behavior) as self.mock_requests,):
            yield merchant_client

    def test_deposit_new_flow_success(self, c, wallet_stp_spei, client, customer, customer_limit):
        random.seed(42)
