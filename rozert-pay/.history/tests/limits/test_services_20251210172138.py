...
class TestRiskAndBusinessLimitCategories:
    def test_business_customer_limit_always_checked(self, customer):
        ...
        should_check, reason = limits._should_check_customer_limit(
            business_limit,
            payment_transaction,
    ...
    def test_business_merchant_limit_always_checked(self, merchant, wallet):
        ...
        should_check, reason = limits._should_check_merchant_limit(
            business_limit,
            payment_transaction,
        )
        assert should_check is True
...
class TestResolveLimitConflicts:
    def test_customer_limits_override_merchant_operation_limits(
        ...
        resolved_limits, filtered = limits._resolve_customer_and_merchant_limit_conflicts(
            limits_list,
        )
