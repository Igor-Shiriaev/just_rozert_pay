...
from rozert_pay.limits.admin.customer_limits import CustomerLimitAdmin
...
from rozert_pay.limits.admin.merchant_limits import MerchantLimitAdmin
...
class TestMerchantAdmin:
    ...
    def test_links(self, admin):
        ...
        assert "Merchant Business Limits" in links_html
        assert "Merchant Risk Limits" in links_html
