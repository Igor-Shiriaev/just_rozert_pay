...
from rozert_pay.limits.services.limits import _resolve_customer_and_merchant_limit_conflicts
...
class TestResolveLimitConflicts:
    def test_no_conflicts_no_customer_limits(self, merchant: Merchant):
        ...
        resolved_limits = _resolve_customer_and_merchant_limit_conflicts(limits)  # type: ignore[arg-type]
    ...
    def test_customer_min_operation_limit_removes_merchant_min_limit(
        ...
        resolved_limits = _resolve_customer_and_merchant_limit_conflicts(limits)
