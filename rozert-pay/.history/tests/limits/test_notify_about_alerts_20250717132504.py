...
class TestNotifyAboutAlerts:
    @pytest.fixture
    def customer_limit_critical(self, customer):
    ...
    @pytest.fixture
    def customer_limit_regular(self, customer):
        return CustomerLimitFactory.create(
            customer=customer,
            is_critical=False,
            decline_on_exceed=False,
    ...
    @pytest.fixture
    def merchant_limit_critical(self, merchant):
    ...
    @pytest.fixture
    def merchant_limit_regular(self, merchant):
        return MerchantLimitFactory.create(
            merchant=merchant,
            is_critical=False,
            decline_on_exceed=False,
    ...
    @pytest.fixture
    def payment_transaction(self, customer):
    ...
    def test_empty_alerts_list_does_nothing(
        ...
        """Test that empty alerts list doesn't trigger any notifications."""
    ...
    def test_only_critical_alerts(
        ...
        mock_construct_message,
        mock_notify_slack,
        customer_limit_critical,
        payment_transaction,
    ):
        """Test notification for critical alerts only."""
        mock_construct_message.return_value = "Critical alert message"

        critical_alert = LimitAlert(
    ...
    def test_only_regular_alerts(
        ...
        mock_construct_message,
        mock_notify_slack,
        customer_limit_regular,
        payment_transaction,
    ):
        """Test notification for regular alerts only."""
        mock_construct_message.return_value = "Regular alert message"
        
        regular_alert = LimitAlert(
    ...
    def test_multiple_critical_alerts(
        ...
        merchant_critical_alert = LimitAlert(
    ...
    def test_multiple_regular_alerts(
        ...
        merchant_regular_alert = LimitAlert(
