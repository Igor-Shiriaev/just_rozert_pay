...
from rozert_pay.limits.const import (
    SLACK_PROD_CHANNEL_NAME_CRITICAL_LIMITS,
    SLACK_PROD_CHANNEL_NAME_REGULAR_LIMITS,
)
...
class TestNotifyAboutAlerts:
    ...
    def test_only_critical_alerts(
        ...
        mock_notify_slack.assert_called_once_with(
            kwargs={
                ...
                "channel": SLACK_PROD_CHANNEL_NAME_CRITICAL_LIMITS,
            }
        )
    ...
    def test_only_regular_alerts(
        ...
        mock_notify_slack.assert_called_once_with(
            kwargs={
                ...
                "channel": SLACK_PROD_CHANNEL_NAME_REGULAR_LIMITS,
            }
        )
    ...
    def test_construct_notification_message_called_with_correct_alerts(
        ...
        critical_call_alerts = calls[0][0][0]
        regular_call_alerts = calls[1][0][0]
