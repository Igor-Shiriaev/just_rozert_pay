...
from rozert_pay.risk_lists.const import ParticipationType, ValidFor
...
class TestRiskListEntryModel:
    ...
    def test_save_sets_valid_for_defaults_and_flags(self):
        ...
        assert m.participation_type == ParticipationType.MERCHANT
