...
class TestCalculateClabeCheckDigit:
    ...
    @pytest.mark.parametrize(
        "invalid_input",
        [
            "1234567890123456a",  # Contains a letter
            "123456789012345!",  # Contains a symbol
        ],
    )
    def test_calculate_clabe_check_digit_non_numeric(self, invalid_input):
...
class TestValidateClabe:
    ...
    def test_validate_clabe_valid(self, valid_clabe):
    ...
    @pytest.mark.parametrize(
        ...
        [
            INVALID_CLABE,
            "021790064060296641",  # Different invalid check digit
        ],
    )
    def test_validate_clabe_invalid_checksum(self, invalid_clabe):
    ...
    def test_validate_clabe_invalid_length(self, invalid_clabe):
