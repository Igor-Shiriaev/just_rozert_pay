...
class TestCheckBitsoSpeiBankCodes:
    ...
    def test_update_existing_bank(
        ...
        existing_bank = BitsoSpeiCardBank.objects.get(code="40012")
        assert existing_bank.name != "BBVA Bancomer NEW"
        ...
        print('111111111111111', BitsoSpeiCardBank.objects.filter(code="40012").all())
