...
class TestCheckBitsoSpeiBank Codes:
    ...
    def test_successful_api_response_with_matching_banks(
        ...
        """Test successful processing with matching PaymentCardBank objects."""
        mock_response = Mock()
        ...
        mock_get.assert_called_once_with("https://bitso.com/api/v3/banks/MX", timeout=10)
