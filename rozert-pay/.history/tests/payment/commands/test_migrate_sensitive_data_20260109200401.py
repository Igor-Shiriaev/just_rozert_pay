...
class TestMigrateSensitiveDataCommand:
    ...
    def test_migrates_wallet_with_credentials(self) -> None:
        ...
        # Set old credentials field and clear encrypted field
    ...
    def test_skips_wallet_with_existing_credentials_encrypted(self) -> None:
        ...
        original_skip_credentials = wallet_to_skip.credentials_encrypted.get_secret_value()  # type: ignore[attr-defined]
        ...
        assert wallet_to_migrate.credentials_encrypted.get_secret_value() == credentials_to_migrate  # type: ignore[attr-defined]

        # Verify second wallet was not changed
        assert wallet_to_skip.credentials_encrypted.get_secret_value() == original_skip_credentials  # type: ignore[attr-defined]
