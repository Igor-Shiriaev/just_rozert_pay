...
@pytest.fixture
def wallet_rozert_crypto(merchant: models.Merchant) -> models.Wallet:
    return WalletFactory.create(
        merchant=merchant,
        system__type=PaymentSystemType.ROZERT_CRYPTO,
        system__name="Rozert Crypto",
        default_callback_url="https://callbacks",
        credentials={
            "base_url": "https://crypto.rozert.cloud",
            "api_key": "test_api_key",
            "webhook_secret": "test_webhook_secret",
            "processing_key": "rozert-dev",
        },
=======
