...
from rozert_pay.payment.models import CurrencyWallet, PaymentTransaction, Wallet
...
class TestConektaOxxoFlow:
    def test_deposit_flow(self, wallet_conekta_oxxo: Wallet, merchant_client: APIClient):
