...
class TestD24MercadoPagoSystem:
    def test_deposit_success(
        self, merchant_client, api_client, merchant, wallet_d24_mercadopago, mock_on_commit
    ):
        with requests_mock.Mocker() as m:
            ...
            # Callback
            response = merchant_client.post(
                "/api/payment/v1/callback/d24-mercadopago/",
    ...
    def test_actualization(self, wallet_d24_mercadopago, merchant, mock_on_commit):
        trx = PaymentTransactionFactory.create(
            wallet__wallet=wallet_d24_mercadopago,
