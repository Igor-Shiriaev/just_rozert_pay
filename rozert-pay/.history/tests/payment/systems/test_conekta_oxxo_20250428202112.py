...
class TestConektaOxxoFlow:
    def test_deposit_flow_success(self, merchant: Merchant, wallet_conekta_oxxo: Wallet, merchant_client: APIClient):
    ...
    def test_deposit_flow_declined(self, merchant: Merchant, wallet_conekta_oxxo: Wallet, merchant_client: APIClient):
        with requests_mock.Mocker() as m:
            m.post(
                url='https://conekta/orders/',
                json={
