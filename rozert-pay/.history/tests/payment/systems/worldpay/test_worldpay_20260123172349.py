...
from rozert_pay.payment.systems.worldpay.helpers import generate_3ds_jwt, generate_ddc_jwt
...
class TestGenerateDdcJwt:
    ...
    def test_custom_expiration(self):
        ...
        token = generate_ddc_jwt(jwt_issuer, jwt_org_unit_id, jwt_mac_key, exp_seconds=3600)
    ...
    def test_unique_session_id_per_call(self):
        ...
        token1 = generate_ddc_jwt(jwt_issuer, jwt_org_unit_id, jwt_mac_key)
        token2 = generate_ddc_jwt(jwt_issuer, jwt_org_unit_id, jwt_mac_key)
...
class TestGenerate3dsJwt:
    ...
    def test_unique_jti_per_call(self):
        ...
        token1 = generate_3ds_jwt(
            jwt_issuer, jwt_org_unit_id, jwt_mac_key,
            "url", "acs", "payload", "txn1"
        )
        token2 = generate_3ds_jwt(
            jwt_issuer, jwt_org_unit_id, jwt_mac_key,
            "url", "acs", "payload", "txn2"
        )
...
class TestWorldpaySystem:
    ...
    def test_deposit_with_3ds_challenge(
        ...
        with requests_mock.Mocker() as m:
            ...
            assert response_data["customer_redirect_form_data"] is not None
            assert response_data["customer_redirect_form_data"]["method"] == "post"
            assert "JWT" in response_data["customer_redirect_form_data"]["fields"]
    ...
    def test_deposit_with_3ds_challenge_v210_uses_fixed_iframe_size(
        ...
        with requests_mock.Mocker() as m:
            ...
            assert response_data["customer_redirect_form_data"]["fields"]["iframeHeight"] == 390
            assert response_data["customer_redirect_form_data"]["fields"]["iframeWidth"] == 400
