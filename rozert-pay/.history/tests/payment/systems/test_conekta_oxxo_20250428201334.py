...
from rozert_pay.payment.models import (CurrencyWallet, Merchant,
...
class TestConektaOxxoFlow:
    def test_deposit_flow(self, merchant: Merchant, wallet_conekta_oxxo: Wallet, merchant_client: APIClient):
        with requests_mock.Mocker() as m:
            ...
            with patch('rozert_pay.payment.systems.conekta.conekta_oxxo.ConektaOxxoClient._validate_conekta_webhook_signature', return_value=True):
                response = merchant_client.post(
