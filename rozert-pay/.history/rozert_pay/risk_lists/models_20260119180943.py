...
class RiskListEntry(models.Model):
    ...
    participation_type = models.CharField(
        ...
        help_text=_("The scope of this entry."),
    )
    ...
    time_added = models.DateTimeField(verbose_name=_("Time Added"), auto_now_add=True)
    ...
    def save(self, *args: Any, **kwargs: Any) -> None:
        ...
        if self.list_type == ListType.BLACK:
            ...
            self.valid_for = ValidFor.PERMANENT
            self.participation_type = ParticipationType.MERCHANT
    ...
    def set_expiration(self) -> None:
        if self.valid_for == ValidFor.PERMANENT:
            ...
            base_dt = self.time_added or timezone.now()
    ...
    def clean(self) -> None:
        ...
        if self.participation_type == ParticipationType.GLOBAL:
            if self.merchant:
        ...
        elif self.participation_type == ParticipationType.MERCHANT:
        ...
        elif self.participation_type == ParticipationType.WALLET:
            if not self.wallet:
                errors.setdefault("wallet", []).append(
        ...
        if self.participation_type == ParticipationType.GLOBAL and self.list_type in [
            ListType.BLACK,
            ListType.GRAY,
        ]:
            field_count = len(
