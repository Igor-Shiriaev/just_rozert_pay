...
class Command(BaseCommand):
    ...
    def handle(self, **options: Any) -> None:
        fillin_bins(self, options.get("path", "bins.json.zip"))


def fillin_bins(command: BaseCommand, path: str = "bins.json.zip") -> None:
    ...
    for bank_name in bank_names:
        ...
        command.stdout.write(bank_name)
    ...
    for card_bin, data in card_bins.items():
        ...
        command.stdout.write(f"{card_bin} {created}")
