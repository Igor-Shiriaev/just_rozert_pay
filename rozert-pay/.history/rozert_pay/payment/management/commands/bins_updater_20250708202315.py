...
class Command(BaseCommand):
    ...
    def handle(self, **options: Any) -> None:
        fillin_bins(options.get("path", "bins.json.zip"), self.stdout.write)


def fillin_bins(path: str = "bins.json.zip", output_fn: Callable[[str], None] = None) -> None:
