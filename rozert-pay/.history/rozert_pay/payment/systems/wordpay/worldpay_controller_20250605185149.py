...
from rozert_pay.payment.services.error import Error
...
class WorldpayController(
    ...
    def _parse_callback(self, cb: IncomingCallback) -> RemoteTransactionStatus:
        ...
        remote_transaction_status: entities.RemoteTransactionStatus | Error = self.client_cls(trx_id=transaction_id).get_transaction_status()
