        ...
        "paymentService": {
            ...
            "submit": {
                "order": {
                    ...
                    "shippingAddress": {
                        "address": {
                            "firstName": user_data.shipping_first_name,
                            "lastName": user_data.shipping_last_name,
                            "street": user_data.shipping_street,
                            "houseNumber": user_data.shipping_house_number,
                            "postalCode": user_data.shipping_post_code,
                            "city": user_data.shipping_city,
                            "countryCode": user_data.shipping_country
                        }
                    }
                }
            }
