...
class WorldpayClient(base_classes.BasePaymentClient[WorldpayCreds]):
    ...
    def deposit(self) -> entities.PaymentClientDepositResponse:
        ...
        xml_payload: str = self._build_xml_payload(card_data, self.trx.user_data)
    ...
    def _build_xml_payload(self, card_data: entities.CardData, user_data: entities.UserData) -> str:
