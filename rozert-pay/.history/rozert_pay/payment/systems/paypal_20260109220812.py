...
class PaypalClient(base_classes.BasePaymentClient[PaypalCredentials]):
        ...
        if self.trx.type == const.TransactionType.DEPOSIT:
            ...
            result = entities.RemoteTransactionStatus(
                ...
                operation_status={
                    ...
                    "VOIDED": entities.TransactionStatus.CHARGED_BACK,
            ...
            return entities.RemoteTransactionStatus(
                ...
                operation_status={
                    ...
                    "REFUNDED": entities.TransactionStatus.CHARGED_BACK,
    ...
    def deposit(self) -> entities.PaymentClientDepositResponse:
        ...
        payload = {
            ...
            "payer": {
                ...
                "address": {
                    ...
                    "admin_area_1": self.trx.user_data.state or "MX",
        ...
        return entities.PaymentClientDepositResponse(
            ...
            customer_redirect_form_data=TransactionExtraFormData(
                action_url=approve_link, method="get"
            ),
        )
    ...
    def withdraw(self) -> entities.PaymentClientWithdrawResponse:
        ...
        account = self.trx.customer_external_account.unique_account_number
        assert account
        payload = {
            "items": [
                {
...
class PaypalController(PaymentSystemController[PaypalClient, SandboxPaypalClient]):
    ...
    def _run_deposit(
        self, trx_id: types.TransactionId, client: PaypalClient | SandboxPaypalClient
    ) -> None:
...
class PaypalDepositSerializer(  # type: ignore[misc]
    ...
    def _get_extra(self) -> dict[str, Any]:
        return {
            "paypal_type": self.validated_data["type"],
        }
