...
from rozert_pay.payment.services import db_services, deposit_services, event_logs
...
worldpay_controller = WorldpayController(
    ...
    default_credentials={
        ...
        "three_ds_challenge_action_url": "https://centinelapistag.cardinalcommerce.com/V2/Cruise/StepUp",
    },
)
