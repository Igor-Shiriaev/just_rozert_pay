...
from rozert_pay.payment.systems.d24_mercadopago.entities import D24MercadoPagoCredentials

logger = logging.getLogger(__name__)


class D24MercadoPagoClient(BasePaymentClient[D24MercadoPagoCredentials]):
    credentials_cls = D24MercadoPagoCredentials
