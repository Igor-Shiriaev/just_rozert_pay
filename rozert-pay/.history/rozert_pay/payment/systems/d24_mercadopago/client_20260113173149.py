...
class D24MercadoPagoClient(BasePaymentClient[D24Credentials]):
    ...
    def _get_deposit_status(self) -> RemoteTransactionStatus:
        ...
        return RemoteTransactionStatus(
            ...
            decline_reason=decline_reason,
            remote_amount=Money(response["local_amount"], response["currency"]),
        )
    ...
    def __get_deposit_request_headers(self, payload: str) -> dict[str, str]:
    ...
    def _make_request(
        ...
        # Basically D24 returns 412 HTTP status code as 400
