...
class ConektaOxxoClient(base_classes.BasePaymentClient[ConektaOxxoCredentials]):
    ...
    def deposit(self) -> dict[str, Any]:
        ...
        assert self.trx.redirect_url, "Redirect URL is required"billing_address = transaction.get_billing_address_or_return_user_last()
        ...
        payload = {
            ...
            'charges': [
                {'payment_method': self._get_deposit_payment_method_data(request, transaction)}
            ],
        }
