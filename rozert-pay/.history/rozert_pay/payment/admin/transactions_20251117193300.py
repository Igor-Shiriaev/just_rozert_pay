                    ...
                    data.append(
                        {
                            ...
                            + f"?id__in={','.join(str(limit.customer_limit.pk) for limit in risk_customer_limit)}",
                    ...
                    data.append(
                        {
                            ...
                            + f"?id__in={','.join(str(limit.customer_limit.pk) for limit in business_customer_limit)}",
