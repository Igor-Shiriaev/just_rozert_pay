...
class RouterDepositViewSet(
    ...
    @extend_schema(
        summary="Create routed deposit transaction",
        description="Automatically selects the best payment provider wallet based on routing rules and creates a deposit transaction.",
    )
