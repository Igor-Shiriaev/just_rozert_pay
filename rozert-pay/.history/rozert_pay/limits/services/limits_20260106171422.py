...
def _should_check_customer_limit(
    ...
    if limit.category == LimitCategory.BUSINESS:
        ...
        return (
            False,
            "business limit but customer has risk_control and the limit is in gray_list",
        )
    ...
    if limit.category == LimitCategory.RISK:
        ...
        return (
            False,
            "risk limit but customer lacks risk_control or the limit is not in gray_list",
        )
...
def _should_check_merchant_limit(
    ...
    return (
        False,
        f"risk/global_risk limit but risk_control not enabled (category={limit.category})",
    )
    ...
    if filtered_out_customer_limits:
        logger.info(
            ...
            extra={
                ...
                "filtered_limits": [
                    {"limit_id": filtered_out_limit.limit.id, "limit_type": filtered_out_limit.limit.limit_type, "reason": filtered_out_limit.reason}
