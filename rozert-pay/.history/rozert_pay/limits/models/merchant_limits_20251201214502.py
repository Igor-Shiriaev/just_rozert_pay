...
from rozert_pay.limits.const import LimitType
from rozert_pay.limits.models.common import BaseLimit, LimitCategory
...
class MerchantLimit(BaseLimit):
    ...
    def clean(self) -> None:
        ...
        if self.category == LimitCategory.GLOBAL_RISK and (
            self.scope != MerchantLimitScope.WALLET or not self.wallet
        ):
...
class RiskMerchantLimit(MerchantLimit):
    objects: ClassVar[models.Manager["RiskMerchantLimit"]] = RiskMerchantLimitManager()  # type: ignore[misc, assignment]
...
class BusinessMerchantLimit(MerchantLimit):
    objects: ClassVar[models.Manager["BusinessMerchantLimit"]] = BusinessMerchantLimitManager()  # type: ignore[misc, assignment]
...
class GlobalRiskMerchantLimitManager(models.Manager["MerchantLimit"]):
    def get_queryset(self) -> models.QuerySet["MerchantLimit"]:
        return super().get_queryset().filter(category=LimitCategory.GLOBAL_RISK)


class GlobalRiskMerchantLimit(MerchantLimit):
    objects: ClassVar[models.Manager["GlobalRiskMerchantLimit"]] = GlobalRiskMerchantLimitManager()  # type: ignore[misc, assignment]
