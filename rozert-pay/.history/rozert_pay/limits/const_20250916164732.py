...
VERBOSE_NAME_MIN_AMOUNT_SINGLE_OPERATION = "Минимальная сумма одной операции"
VERBOSE_NAME_MAX_AMOUNT_SINGLE_OPERATION = "Максимальная сумма одной операции"
...
class LimitType(TextChoices):
    ...
    MIN_AMOUNT_SINGLE_OPERATION = (
        "min_amount_single_operation" "Минимальная сумма одной операции",
    )
