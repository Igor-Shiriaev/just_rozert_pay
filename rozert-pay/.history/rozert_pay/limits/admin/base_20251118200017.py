...
class BaseLimitAdmin(admin.ModelAdmin):
    ...
    invalidate_cache_action.label = _("Enable Risk control")  # type: ignore[attr-defined]
    invalidate_cache_action.short_description = _("Enable Risk control")  # type: ignore[attr-defined]
