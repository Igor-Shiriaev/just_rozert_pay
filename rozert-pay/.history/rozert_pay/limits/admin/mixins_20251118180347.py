...
class RiskControlMixin:
    def enable_risk_control(self: type[admin.ModelAdmin], request: HttpRequest, queryset: QuerySet[CustomerLimit]) -> None:
    ...
    def disable_risk_control(self: type[admin.ModelAdmin], request: HttpRequest, queryset: QuerySet[CustomerLimit]) -> None:
