...
=======
                    ...
                    {
                        "link": reverse("admin:payment_paymenttransaction_changelist")
                        + f"?customer__id__exact={obj.customer.pk}",
                        "name": _("Transactions"),
>>>>>>> Stashed changes
                    },
                ]
...
=======
            ...
            if obj.scope == MerchantLimitScope.MERCHANT and obj.merchant:
                data.append(
                    {
                        "link": reverse("admin:payment_paymenttransaction_changelist")
                        + f"?wallet__wallet__merchant__id__exact={obj.merchant.pk}",
                        "name": _("Transactions"),
                    }
                )
            elif obj.scope == MerchantLimitScope.WALLET and obj.wallet:
                data.append(
                    {
                        "link": reverse("admin:payment_paymenttransaction_changelist")
                        + f"?wallet__wallet__id__exact={obj.wallet.pk}",
                        "name": _("Transactions"),
>>>>>>> Stashed changes
                    }
                )
