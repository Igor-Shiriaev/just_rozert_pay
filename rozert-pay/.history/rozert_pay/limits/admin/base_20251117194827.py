...
from rozert_pay.limits.services.limits import invalidate_limits_cache, switch_all_risk_limits_status
...
class BaseLimitAdmin(admin.ModelAdmin):
    ...
    def enable_risk_control_action(
        ...
        switch_all_risk_limits_status(is_active=True)
    ...
    def disable_risk_control_action(
        ...
        switch_all_risk_limits_status(is_active=False)
