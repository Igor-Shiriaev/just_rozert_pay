...
class LimitAlertAdmin(admin.ModelAdmin):
    ...
    def limit_type_colored(self, obj: LimitAlert) -> str:
        ...
        limit_category = (
            "Risk" if obj.customer_limit and obj.customer_limit.category == LimitCategory.RISK else "Business" if obj.customer_limit and obj.customer_limit.category == LimitCategory.BUSINESS else "N/A"
        )
