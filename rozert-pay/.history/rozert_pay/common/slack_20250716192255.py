...
class SlackClient:
    ...
    def send_message(self, channel: str, text: str) -> None:
        ...
        if response.status_code != 200:
            response_data = response.data if isinstance(response.data, dict) else json.loaresponse.data.decode()
            logger.error(
        ...
        logger.info(
            ...
            extra={"message": text, "channel": channel, "response": response.data},
        )
        return
