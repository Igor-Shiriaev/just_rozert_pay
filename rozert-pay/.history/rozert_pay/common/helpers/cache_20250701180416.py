...
def memory_cache_get_set(
    ...
    if v is None:
        # If on_miss returns None, we need to handle this case
        # This should not happen if on_miss is properly implemented
        raise ValueError(f"Cache miss for key {key} and on_miss returned None")
    return v
