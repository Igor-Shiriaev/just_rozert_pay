...
def memory_cache_get_set(
    ...
    # Since on_miss is provided and returns T, v should never be None
    # But mypy can't infer this, so we need to handle it explicitly
    assert v is not None, f"Cache miss for key {key} and on_miss returned None"
    return v
